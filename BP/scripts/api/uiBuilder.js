...
import { uiBuilderSystem } from "../config";
...
class UIBuilder {
    constructor() {
        ...
        system.afterEvents.scriptEventReceive.subscribe(e=>{
            ...
            if(e.sourceType == ScriptEventSource.Entity && e.id == "simple:open") {
                if (!uiBuilderSystem === true) return e.sourceEntity.sendMessage(translation.getTranslation(e.sourceEntity, 'error', 'UI Builder is not enabled!'))
