...
commandManager.addCommand("help", {description: "Get help with Simple Essentials", category: "Help", format: `-help`}, ({msg,args})=>{
...
commandManager.addSubcommand("help", "setup", {description: "Get help setting up Simple Essentials"}, ({msg})=>{
    msg.sender.sendMessage("Coming Soon!")
})
commandManager.addSubcommand("help", "version", {description: "Version of simple essentials"}, ({msg})=>{
    msg.sender.sendMessage(`Simple Essentials Version - 0.1.5 BETA`);
    msg.sender.sendMessage(`PrismarineDB Version - V${prismarineDb.version.toFixed(1)}`);
})
